...
echo "Quick version:"
echo "  mkdir -p /Volumes/Gaia/04_DEV/store-manager/ingest/Apps/darkwave/${VERSION}"
echo "  cp \"$DMG_OUT\" /Volumes/Gaia/04_DEV/store-manager/ingest/Apps/darkwave/${VERSION}/Darkwave.dmg"
