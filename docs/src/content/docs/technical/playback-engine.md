...
Future Milestone 2 work will connect this state model to arbitrary-format decoding, resampling, cancellation handles, playback speed, and measured startup latency.
